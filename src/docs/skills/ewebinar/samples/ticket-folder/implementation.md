...
- [ ] Verify the active locations tab shows only municipalities that have active locations.
- [ ] Verify the request locations tab shows only municipalities that have request locations.
- [ ] Verify switching between active and request tabs does not carry over the municipality filter from one tab to the other.
